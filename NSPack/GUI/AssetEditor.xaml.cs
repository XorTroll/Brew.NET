...
namespace Brew.NSPack.GUI
{
    public partial class AssetEditor : Page
    {
        ...
        {
            System.Windows.MessageBox.Show("The logo directory must contain just two files: a GIF file and a PNG file.\nThe GIF and the PNG need to be made using Photoshop!\nHorizon reads their metadata, otherwise they won't work!", "Test - Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
        ...
        private void Button_BuildNSP_Click(object sender, RoutedEventArgs e)
        {
            ...
            if(hasoff)
            {
                ...
                noff.Type = NCAType.LegalInformation;
                ...
                FileSystem.CopyDirectory(off, HacPack.Utils.TemporaryDirectory + "\\offline\\main.htdocs");
